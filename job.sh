...
hostname
uv run python3 code/procedural_text_process.py data/allrecipes-recipes outs/outs_16 --limit 200 --log-level TRACE
zip -r outs/outs_16.zip outs/outs_16 &> zip.out
